...
| D16 | PTT par défaut, wake word en option | always-on par défaut | Fiabilité et respect de la vie privée |
...
| **D29** | **Seuil de confiance à 0,40** pour l'étage à grammaire | 0,50 | Balayage mesuré : à 0,40 les 21 énoncés passent, à 0,45 il en manque 6, à 0,50 il en manque 9. **À recalibrer** dès qu'on disposera d'énoncés hors grammaire en nombre — un seul témoin ne suffit pas à borner les faux déclenchements |
