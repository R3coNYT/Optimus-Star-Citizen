...
Le détail vit désormais dans [`14-signature-de-code.md`](14-signature-de-code.md) : conditions relevées chez la fondation, chaîne de compilation, politique de signature et ce qu'il reste à faire. **Trois des conditions manquent, et elles tiennent toutes à une seule décision du pilote** — rendre le dépôt public sous une licence libre.
